          ...
          <details className="group rounded-2xl border border-slate-800 bg-slate-950/60 transition-all">
            ...
            <div className="space-y-3 border-t border-slate-800/60 p-4 pt-3 text-sm text-slate-300 sm:text-base">
              <p className="max-w-2xl">
                Upload a photo to preview it and pull out the original capture date, latitude, and longitude from its EXIF metadata. That data is then matched to dedicated setlist providers for Phish, Grateful Dead / Dead &amp; Co., King Gizzard &amp; the Lizard Wizard, Billy Strings and more. If no EXIF data is found, you can manually enter a date to see if there was a show on that day. When possible, phish.in data and audio links will be included for Phish shows, or equivalent data for other bands.
              </p>
